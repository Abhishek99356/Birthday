...
// const CONF_COLORS = ["#ffd700","#ff69b4","#c084fc","#38bdf8","#f97316","#4ade80","#f472b6","#a78bfa"];
...
// const BALLOON_COLORS = ["#f87171","#fb923c","#facc15","#4ade80","#60a5fa","#c084fc","#f472b6","#34d399"];
...
// const DETAILS = [
//   { icon:"📅", label:"Date",    value:"20 June 2026", sub:"Saturday",        accent:"#fbbf24" },
//   { icon:"⏰", label:"Waqt",    value:"8:00 PM",      sub:"Onwards",          accent:"#38bdf8" },
//   { icon:"📍", label:"Location",value:"Noida",        sub:"Uttar Pradesh",    accent:"#4ade80" },
//   { icon:"🎊", label:"Theme",   value:"Night Gala",   sub:"Dress to Impress", accent:"#f472b6" },
// ];
...
//       {STARS.map(s => (
//         <div key={s.id} className="bi-star" style={{
...
//     <>
//       {CONFETTI.map(p => (
//         <div key={p.id} className="bi-conf" style={{
//           left:`${p.left}%`, background:p.color,
//           width:p.size, height:p.size,
//           borderRadius:p.circle?"50%":3,
//           "--f":`${p.dur}s`, "--fd":`${p.delay}s`,
//         }}/>
//       ))}
//     </>
//   );
...
//             {/* Balloon body */}
//             <ellipse cx="30" cy="28" rx="26" ry="24" fill={b.color} opacity="0.88"/>
//             {/* Shine */}
//             <ellipse cx="21" cy="17" rx="8" ry="6" fill="white" opacity="0.28"/>
//             <ellipse cx="38" cy="22" rx="3" ry="2.5" fill="white" opacity="0.15"/>
//             {/* Knot */}
//             <circle cx="30" cy="53" r="2.5" fill={b.color} opacity="0.9"/>
//             {/* String */}
//             <path d="M30 55 Q34 63 29 70 Q25 76 30 78" stroke={b.color} strokeWidth="1.5" fill="none" opacity="0.7"/>
//           </svg>
//         </div>
//       ))}
//     </>
...
//     <>
//       {BALLOONS.map(b => (
//         <div key={b.id} className="bi-balloon" style={{
//           left:`${b.left}%`, "--br":`${b.dur}s`, "--brd":`${b.delay}s`,
//         }}>
//           <svg width={b.w} height={b.w*1.28} viewBox="0 0 60 77" fill="none">
//             <ellipse cx="30" cy="28" rx="28" ry="26" fill={b.color} opacity="0.82"/>
//             <ellipse cx="22" cy="18" rx="8"  ry="6"  fill="white"  opacity="0.22"/>
//             <path d="M30 54 Q33 63 30 77" stroke={b.color} strokeWidth="2" fill="none"/>
...
//   return (
//     <div className="relative px-4 sm:px-6 pt-10 sm:pt-12 pb-8 sm:pb-10 text-center" style={{
//       background:"linear-gradient(160deg,rgba(168,85,247,.22) 0%,rgba(236,72,153,.13) 50%,rgba(56,189,248,.09) 100%)",
//       borderBottom:"1px solid rgba(255,255,255,0.08)",
//     }}>
//       <div className="relative inline-flex items-center justify-center mb-4">
//         <div className="bi-ring absolute" style={{ width:110,height:110,borderColor:"rgba(192,132,252,.55)",top:0,left:0,right:0,bottom:0,margin:"auto" }}/>
//         <div className="bi-ring absolute" style={{ width:110,height:110,borderColor:"rgba(236,72,153,.4)",animationDelay:".75s",top:0,left:0,right:0,bottom:0,margin:"auto" }}/>
//         <span className="bi-cake relative z-10 text-6xl sm:text-7xl leading-none">🎂</span>
//       </div>
//       <p className="text-[10px] sm:text-xs tracking-[3px] sm:tracking-[4px] uppercase mb-3 px-2" style={{ color:"rgba(255,200,100,.8)" }}>
//         Aap sabko dil se bulaya ja raha hai — Birthday mein zaroor aaiye 🙏
//       </p>
//       <h1 className="bi-shimmer leading-tight mb-1" style={{ fontSize:"clamp(36px,10vw,72px)" }}>
//         Happy Birthday!
//       </h1>
//       <p className="text-lg sm:text-xl mb-6 px-2" style={{ fontFamily:"'Dancing Script',cursive", color:"rgba(255,255,255,.65)" }}>
...
//           <span key={i} className="bi-float" style={{ "--fi":`${2+i*0.35}s`, "--fid":`${i*0.28}s` }}>{emoji}</span>
//         ))}
//       </div>
//     </div>
//   );
...
//   return (
//     <div className="bi-detail-card rounded-2xl p-3 sm:p-4 text-center" style={{
//       background:"rgba(255,255,255,0.055)",
//       border:`1px solid ${accent}45`,
//       boxShadow:`0 0 0 1px ${accent}12 inset`,
//     }}>
//       <div className="text-2xl sm:text-3xl mb-1 sm:mb-2">{icon}</div>
//       <div className="text-[9px] sm:text-[10px] tracking-[2px] uppercase mb-1 font-medium" style={{ color:accent }}>{label}</div>
//       <div className="text-white font-semibold text-[13px] sm:text-[15px] mb-0.5">{value}</div>
...
//       <div className="rounded-2xl px-3 sm:px-4 py-2 min-w-[56px] sm:min-w-[68px]" style={{
//         background:"rgba(255,255,255,0.08)",
//         border:"1px solid rgba(255,255,255,0.18)",
//         backdropFilter:"blur(8px)",
//       }}>
//         <span className="block text-3xl sm:text-4xl leading-tight font-bold" style={{
...
//         </span>
//       </div>
//       <span className="block mt-1.5 text-[9px] sm:text-[10px] tracking-[2px] uppercase text-white/40">{label}</span>
//     </div>
//   );
// }
...
//   const colors = ["#ffd700","#ff69b4","#c084fc","#38bdf8","#f97316","#4ade80"];
//   for (let i = 0; i < 18; i++) {
//     setTimeout(() => {
...
//         top:`${rand(10,70)}%`, left:`${rand(10,80)}%`,
...
//   const handleConfirm = () => { setDone(true); launchFireworks(); };

//   return (
//     <div className="fixed inset-0 z-50 flex items-center justify-center p-4"
//       style={{ background:"rgba(0,0,0,0.78)", backdropFilter:"blur(8px)" }}>
//       <div className="bi-modal-in w-full max-w-sm text-center rounded-3xl p-8 sm:p-10" style={{
...
//           <h3 className="text-3xl sm:text-4xl mb-2" style={{ fontFamily:"'Dancing Script',cursive", color:"#fde68a" }}>
//             Pakka Aaoge?
//           </h3>
//           <p className="text-white/65 text-sm leading-relaxed mb-6">
//             20 June 2026 — ek aisi raat jo aap kabhi bhool nahi paoge! 🥂
//           </p>
//           <div className="flex flex-col sm:flex-row gap-3">
//             <button onClick={handleConfirm}
//               className="flex-1 py-3 rounded-2xl text-white font-semibold text-base transition-transform hover:scale-105 active:scale-95"
//               style={{ background:"linear-gradient(135deg,#a855f7,#ec4899)" }}>
//               ✅ Bilkul Aaunga!
//             </button>
//             <button onClick={onClose}
//               className="flex-1 py-3 rounded-2xl text-white/60 text-sm border transition-transform hover:scale-105 active:scale-95"
...
//           </h3>
//           <p className="text-white/65 text-sm leading-relaxed mb-6">
//             Aapka bahut intezaar rahega! 20 June ko mast party hogi 🎊🎈
//           </p>
//           <button onClick={onClose}
...
//       background:"linear-gradient(145deg,#080015 0%,#1a0533 35%,#0d1a40 70%,#080015 100%)",
...
//             <span className="inline-block px-4 sm:px-5 py-1.5 rounded-full text-[10px] sm:text-xs tracking-[2px] sm:tracking-[3px] uppercase font-medium" style={{
//               background:"rgba(253,230,138,.1)",
//               border:"1px solid rgba(253,230,138,.3)",
//               color:"#fde68a",
//             }}>✨ Special Invitation — Abhishek ki taraf se ✨</span>
//           </div>
...
//             boxShadow:"0 0 100px rgba(192,132,252,.15),0 40px 80px rgba(0,0,0,.55)",
//           }}>
//             <HeroSection />
...
//                 <svg viewBox="0 0 400 20" className="w-full" style={{ height:20, overflow:"visible" }}>
//                   <path className="bi-wave-path"
//                     d="M0 10 Q50 0 100 10 Q150 20 200 10 Q250 0 300 10 Q350 20 400 10"
//                     fill="none" stroke="rgba(192,132,252,0.35)" strokeWidth="1.5"/>
//                 </svg>
//               </div>

//               {/* Countdown */}
//               <div className="rounded-2xl p-4 sm:p-5 mb-5 sm:mb-6" style={{
//                 background:"rgba(253,230,138,.05)",
//                 border:"1px solid rgba(253,230,138,.2)",
//               }}>
//                 <p className="text-center text-[9px] sm:text-[10px] tracking-[2px] sm:tracking-[3px] uppercase mb-3 sm:mb-4" style={{ color:"rgba(255,200,100,.7)" }}>
...
//                 style={{ background:"linear-gradient(135deg,#a855f7 0%,#ec4899 50%,#f97316 100%)", border:"none" }}
...
//                 ✉️ abhishekyadav40854@gmail.com &nbsp;|&nbsp; 📞 9580250997<br/>
//                 <span className="text-white/20 text-[10px] sm:text-[11px]">Aapka intezaar rahega — ek yaadgaar raat hogi 🌙</span>
//               </p>
//             </div>
//           </div>
